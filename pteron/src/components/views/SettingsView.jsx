      ...
      <div className="settings-list">
        <div className="setting-item">
          <div className="setting-info">
            ...
            <div className="setting-description">Automatically suggest saving a link when you visit a page frequently</div>
          </div>
          <ToggleSwitch checked={autoSuggestions} onChange={handleAutoSuggestionsChange} />
        </div>
        <div className="setting-item">
          <div className="setting-info">
            <div className="setting-label">Auto-Open Notes</div>
        ...
        <div className="setting-item setting-item--action">
          <div className="setting-info">
            ...
            <div className="setting-description">Export all links and notes to a JSON file</div>
          </div>
        ...
        <div className="setting-item setting-item--action">
          <div className="setting-info">
            ...
            <div className="setting-description">Import links and notes from a JSON file</div>
          </div>
